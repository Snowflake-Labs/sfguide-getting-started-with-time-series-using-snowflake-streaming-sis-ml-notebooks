...
SELECT * FROM TABLE(HOL_TIMESERIES.ANALYTICS.FUNCTION_TS_INTERPOLATE('/IOT/SENSOR/TAG401', '2024-01-01 01:05:00'::TIMESTAMP_NTZ, '2024-01-01 01:10:00'::TIMESTAMP_NTZ, 10, 31)) ORDER BY TAGNAME, TIMESTAMP;
