...
-- STATISTICAL
-- COUNT
SELECT TAGNAME, COUNT(VALUE) AS VALUE
FROM HOL_TIMESERIES.ANALYTICS.TS_TAG_READINGS
WHERE TIMESTAMP > '2000-03-26 12:45:37'
AND TIMESTAMP <= '2024-04-26 14:45:37'
AND TAGNAME = '/IOT/SENSOR/100'
...
-- COUNT DISTINCT
SELECT TAGNAME, COUNT(DISTINCT VALUE) AS VALUE
FROM HOL_TIMESERIES.ANALYTICS.TS_TAG_READINGS
WHERE TIMESTAMP > '2000-03-26 12:45:37'
AND TIMESTAMP <= '2024-04-26 14:45:37'
AND TAGNAME = '/IOT/SENSOR/100'
...
-- AVG
SELECT TAGNAME, AVG(VALUE_NUMERIC) AS VALUE
FROM HOL_TIMESERIES.ANALYTICS.TS_TAG_READINGS 
WHERE TIMESTAMP > '2000-03-26 12:45:37'
AND TIMESTAMP <= '2024-04-26 14:45:37'
AND TAGNAME = '/IOT/SENSOR/100'
...
-- STDDEV
SELECT TAGNAME, STDDEV(VALUE_NUMERIC) AS VALUE
FROM HOL_TIMESERIES.ANALYTICS.TS_TAG_READINGS
WHERE TIMESTAMP > '2000-03-26 12:45:37'
AND TIMESTAMP <= '2024-04-26 14:45:37'
AND TAGNAME = '/IOT/SENSOR/100'
...
-- VARIANCE
SELECT TAGNAME, VARIANCE(VALUE_NUMERIC) AS VALUE
FROM HOL_TIMESERIES.ANALYTICS.TS_TAG_READINGS
WHERE TIMESTAMP > '2000-03-26 12:45:37'
AND TIMESTAMP <= '2024-04-26 14:45:37'
AND TAGNAME = '/IOT/SENSOR/100'
